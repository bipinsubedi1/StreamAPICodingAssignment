...
public class PartOne {
	public static void main(String[] args) {
		...
		List<Integer> employeeSalaryList2 = employeeList.stream().filter(s -> s.salary > 1000)// filtering data
		...
		List<Integer> employeeAgeList2 = employeeList.stream().filter(a -> a.age > 30)// filtering data
